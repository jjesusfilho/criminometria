...
E-mail: $if(email)$\texttt{$email$}$else$$endif$ & Web: $if(web)$\href{http://$web$}{\tt $web$}$else$$endif$\\
Telefone: $if(telefone)$$telefone$$else$$endif$  &  Endereço: $if(endereco)$$endereco$$else$$endif$\\
CNPJ: $if(CNPJ)$$CNPJ$$else$$endif$ &  $if(cep)$$cep$$else$$endif$\\
